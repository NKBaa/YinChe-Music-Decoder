...
class MainWindow(QMainWindow):
    ...
    def build_ui(self):
        ...
        subtitle = QLabel("网易云 · QQ 音乐 · 酷狗 · 酷我 · 喜马拉雅 · 咪咕"); subtitle.setObjectName("muted"); titles.addWidget(subtitle)
        ...
        preserve_title = QHBoxLayout(); preserve_title.setSpacing(9)
        preserve_title.addWidget(self.preserve); preserve_title.addWidget(QLabel("保留目录结构")); preserve_title.addStretch()
        preserve_help = QLabel("输出时复刻导入文件夹内的子目录层级"); preserve_help.setObjectName("helper")
        self.recursive = ToggleSwitch(True)
        self.recursive.setToolTip("导入文件夹时，同时搜索其中的所有子文件夹")
        recursive_title = QHBoxLayout(); recursive_title.setSpacing(9)
        recursive_title.addWidget(self.recursive); recursive_title.addWidget(QLabel("递归扫描")); recursive_title.addStretch()
        recursive_help = QLabel("导入文件夹时，同时搜索其中的所有子文件夹"); recursive_help.setObjectName("helper")
        ...
        threads_line.addStretch(); threads_line.addWidget(self.thread_count)
        threads_help = QLabel("机械硬盘 2–4，SSD 4–8；20 线程可能受磁盘限制"); threads_help.setObjectName("helper")
        scan_options.addLayout(preserve_title, 0, 0); scan_options.addLayout(recursive_title, 0, 1); scan_options.addLayout(threads_line, 0, 2)
        scan_options.addWidget(preserve_help, 1, 0); scan_options.addWidget(recursive_help, 1, 1); scan_options.addWidget(threads_help, 1, 2)
        scan_options.setColumnStretch(0, 1); scan_options.setColumnStretch(1, 1); scan_options.setColumnStretch(2, 1)
